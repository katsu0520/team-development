...
<div class="splide__track top-0 left-0 w-full h-screen">
    <ul class="splide__list">
        ...
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            <div class="absolute inset-0 bg-[rgba(255,118,141,0.85)] rounded-tl-3xl rounded-bl-3xl clip-path-polygon z-0"></div>
        ...
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            <div class="absolute inset-0 bg-white rounded-tl-3xl rounded-bl-3xl clip-path-polygon z-0"></div>
            <div class="flex">
        ...
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            <div class="absolute inset-0 bg-[#FE899D] rounded-tl-3xl rounded-bl-3xl clip-path-polygon z-0"></div>
        ...
        <button class="next-btn absolute right-4 bottom-4 bg-white text-customNavy px-6 py-2 rounded-md shadow-sm flex items-center space-x-2 mr-10 mb-9" data-url="{{ route('dashboard') }}">
